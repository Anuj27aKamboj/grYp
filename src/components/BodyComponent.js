  ...
  return listOfRestaurants.length === 0 ? (<ShimmerCommponent />) : (
    <div className="mt-[120px]">
      <div className="fixed left-0 top-[110px] ml-2 text-[1.5rem] z-9999">
        <div>{internetStatus === true? "🟢":"🔴"}</div>{!internetStatus && (
        <div className="fixed inset-0 flex justify-center items-center backdrop-blur-sm z-10000">
          <div className="bg-[rgba(80,80,80,0.35)] border border-[rgba(255,255,255,0.15)]
           rounded-2xl px-[60px] py-10 text-center
           shadow-[0_8px_32px_rgba(0,0,0,0.4)]
           backdrop-blur-[25px]">
            <h2 className="mb-2.5">Connection Error!</h2>
            <h4 className="font-normal opacity-85">Please check your internet connection and try again.</h4>
          </div>
        </div>
      )}
      </div>
      <div className="flex flex-row w-[150px] my-2.5 mx-auto">
        ...
        ></input>
        <button className="py-[5px] px-2.5 mx-[5px] rounded-[10px] border-none 
           bg-slate-100 text-slate-900 hover:bg-slate-200 cursor-pointer" onClick={() => {
      ...
      <div className="flex flex-wrap justify-center w-10/12 py-[5px] px-5 mx-auto mt-[25px]">
